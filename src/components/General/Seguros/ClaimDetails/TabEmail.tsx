...
function TabEmail(props: any) {
    ...
    const onSubmit = async (data: EmailData) => {
        try {
            ...
            const response = await ClaimsService.postClaimsEmail(data);
            
            await ClaimsService.patchFlags(props.folio, "emailNotification", true);
            await ClaimsService.patchFlags(props.folio, "hasLogs", true);
        ...
        //********************************************************************************* */
        /*
        ReceiptsService.postReceiptsLogs(props.folio, insuranceLogData)
            .then((result) => {
