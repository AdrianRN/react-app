...
import PersonDataTab from './PersonDataTab';
...
function HealthPolicyTabs(props: any) {
        ...
        <Paper square={false} elevation={8} sx={{ p: 2, borderRadius: 4 }}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <Tabs value={tabIndex} onChange={handleChange}>
              ...
              <Tab disabled={isDisabled()} label={<Typography sx={LinkSmallFont}>Datos de persona(s)</Typography>} {...a11yProps(1)} />
          ...
          <Box>
            ...
            <CustomTabPanel value={tabIndex} index={1}>
              <PersonDataTab data={props} policy={policyFolio} modifyValueDisabled={disabled} onDataChange={handleSavePolicy} />
            </CustomTabPanel>
            ...
            <CustomTabPanel value={tabIndex} index={3}>
              <TabReceipts data={policyFolio} modifyValueDisabled={disabled} />
            </CustomTabPanel>
          </Box>
        </Paper>
      </Box>
...
export default HealthPolicyTabs
